...
#BLOG_DESCRIPTION = "Aiyumi's blog"  # (translatable)
BLOG_DESCRIPTION = {
...
sidebar_links_list = {
    DEFAULT_LANG: (
        ...
        ("http://www.fanfiction.net/u/1478552/", U"Fanfiction", U"Minhas fan fictions (em Português e Inglês)."),
        ...
        ("http://tecnoveneno.blogspot.com/", U"Tecnoveneno", U"Blog de um amigo meu, sobre aplicativos de linha de comando, Unix, programação (principalmente em Perl) e manipulação de strings (texto). Em Português."),
        ("https://perspicazsite.wordpress.com/", U"Perspicazsite", U"O novo blog do mesmo amigo acima. Diferente do blog anterior, este abrange muito mais assuntos além de programação. Em Português."),
        ("", "", U"Lojas Recomendadas"),
        ("http://www.amazon.com/gp/redirect.html?ie=UTF8&location=http%3A%2F%2Fwww.amazon.com%2F&tag=aiyumysites01-20&linkCode=ur2&camp=1789&creative=390957", U"Amazon.com", U"Uma das maiores lojas online, com produtos que vão de brinquedos, CDs, DVDs, jogos e livros, até computadores, instrumentos musicais, roupas e acessórios para automóveis. Pena que não envia alguns produtos (dentre eles, jogos) para o Brasil."),
        ("http://www.play-asia.com/SOap-23-83-49xb.html", U"Play-Asia.com", U"DVDs de anime, jogos (versão japonesa e americana), CDs de trilha sonora (OSTs) e outras coisas. Entrega praticamente para o mundo todo (inclusive o Brasil). Site em vários idiomas, inclusive Português."),
        ("", "", U"Desenvolvimento Web"),
        ("http://www.wolfcms.org/", U"WolfCMS", U"O CMS que a versão anterior deste site usava. Bastante leve, rápido e flexível. Site em Inglês."),
        ("https://getnikola.com/", U"Nikola", U"O sistema de blog que este site usa atualmente. Bastante customizável. Site em Inglês."),
        ("http://www.dreamhost.com/r.cgi?362621", U"DreamHost.com", U"O serviço de hospedagem que este site usava anteriormente. Tem muitas características interessantes como suporte para scripts em PHP, Perl, Python e outras linguagens, acesso Shell ao servidor e ótima documentação sobre como utilizar os serviços. Apesar de não usar mais esta hospedagem, eu ainda recomendo. Em Inglês."),
    ...
    "en": (
        ...
        ("http://www.fanfiction.net/u/1478552/", U"Fanfiction", U"My fan fictions (in Portuguese and English)."),
        ...
        ("http://tecnoveneno.blogspot.com/", U"Tecnoveneno", U"Blog of a friend of mine, about command line apps, Unix, programming (mainly in Perl) and string (text) manipulation. In Portuguese."),
        ("https://perspicazsite.wordpress.com/", U"Perspicazsite", U"A new blog by the same friend as above. Differently from the previous blog, this one talks about a lot more subjects besides programming. In Portuguese."),
        ("", "", U"Recommended Stores"),
        ("http://www.amazon.com/gp/redirect.html?ie=UTF8&location=http%3A%2F%2Fwww.amazon.com%2F&tag=aiyumysites01-20&linkCode=ur2&camp=1789&creative=390957", U"Amazon.com", U"One of the biggest online stores, with products ranging from toys, CDs, DVDs, games and books, to computers, musical instruments, clothing and car accessories."),
        ("http://www.play-asia.com/SOap-23-83-49xb.html", U"Play-Asia.com", U"Anime DVDs, games (JP and US versions), soundtrack CDs and other things. Worldwide shipping. Site in various languages."),
        ("", "", U"Web Development"),
        ("http://www.wolfcms.org/", U"WolfCMS", U"The CMS this site used previously. Very fast, lightweight and flexible. Site in English."),
        ("https://getnikola.com/", U"Nikola", U"The blog system this site uses now. Very customizable. Site in English."),
        ("http://www.dreamhost.com/r.cgi?362621", U"DreamHost.com", U"This site's previous web host. It has many nice features like support for scripts in PHP, Perl, Python and other languages, Shell access to the server and very good documentation about how to use the services. Even though this site isn't hosted there anymore, I still recommend it. In English."),
    ...
    "ja": (
        ...
        ("http://www.fanfiction.net/u/1478552/", U"Fanfiction", U"私のファンフィクション。（ポルトガル語と英語）"),
        ...
        ("http://tecnoveneno.blogspot.com/", U"Tecnoveneno", U"友人のブログ。Unix、コマンドラインアプリケーション、（主にPerl）プログラミングと文字列操作について語ります。（ポルトガル語）"),
        ("https://perspicazsite.wordpress.com/", U"Perspicazsite", U"上記と同じ友人の新しいブログ。前のブログと違って、プログラミング以外にもより多くの事について語ります。（ポルトガル語）。"),
        ("", "", U"お奨めのオンラインストア"),
        ("http://www.amazon.co.jp/gp/redirect.html?ie=UTF8&location=http%3A%2F%2Fwww.amazon.co.jp%2F%23&tag=aiyumysites01-22&linkCode=ur2&camp=247&creative=7399", U"Amazon.co.jp", U"おもちゃ、CDやDVD、ゲーム、書籍、コンピューター、楽器、車のアクセサリーなど、いろんな商品を売っている有名な通販さいと。"),
