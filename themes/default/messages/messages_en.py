...
MESSAGES = {
    ...
    "afflinks_note": "Note: if you use my links to buy anything at Play-Asia or sign up for webhosting at DreamHost, I might earn a small commission from their affiliate program. This should help me pay for the domain registration for \"warpstar.net,\" as well as help me buy games, virtual musical instruments (sample libraries), VOCALOIDs and the like.",
}
