...
MESSAGES = {
    ...
    "afflinks_note": "注：私のリンクから Play-Asia で何かを購入したり、 DreamHost のウェブホスティングにサインアップした場合、私は彼らのアフィリエイトプログラムから小さなコミッションを稼げることがあります。それは \"warpstar.net\" のドメイン登録の支払いや、ゲーム、VOCALOIDライブラリや他の音楽ソフトなどの購入に役立ちます。",
}
