...
MESSAGES = {
    ...
    "afflinks_note": "Nota: se você usar meus links para comprar algum produto nas lojas que recomendo ou para contratar os serviços de hospedagem da DreamHost, eu posso receber uma pequena comissão do programa de afiliados deles.",
}
